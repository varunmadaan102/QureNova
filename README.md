...
Breast-cancer tabular classification is the validated MVP. The canonical WDBC target is explicitly defined as B=Benign and M=Malignant; QureNova never infers medical meaning from numeric label ordering. The data, model,
